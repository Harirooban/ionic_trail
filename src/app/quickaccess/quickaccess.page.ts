...
export class QuickaccessPage implements OnInit {
	...
	heading:any;
	url_id:any;
  constructor( private httpService : HttpService, private activaterouter : ActivatedRoute , private nav: NavController,private modalController: ModalController) { 
	...
	quickAction(customer) {
		...
		if (this.url_id == 1) {
			...
			this.nav.navigateForward('/newpayment/' + customer.customer_id)
		}
	}
